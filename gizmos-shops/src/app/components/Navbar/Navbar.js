  ...
  return (
    ...
    <div className="max-w-8xl mx-auto px-2 sm:px-6 lg:px-8">
      <div className="relative flex items-center justify-between h-16">
        ...
        {/* Links */}
        <div className="flex items-center justify-center gap-4 px-1 border sm:items-stretch sm:justify-start sm:hidden">
        <div className="flex gap-16 justify-center items-center">
            <h1>All Categories</h1>
        <FontAwesomeIcon icon={faAngleRight} />
        </div>
        <div className="border flex justify-center items-center p-2">
            <input type="text"  placeholder="Search for Products" className="w-72"/>
        ...
        <div className="flex justify-center items-center gap-4 sm:hidden "> 
         ...
         <div>
            <h1 className="font-bold text-xl">+0080 1234 56 789</h1>
        ...
        {/* <div className="flex-1 flex items-center justify-center sm:items-stretch sm:justify-start">
          <div className="hidden sm:block sm:ml-6">
            <div className="flex space-x-4">
              ...
              <a href="#" className="text-black hover:bg-gray-700 hover:text-white px-3 py-2 rounded-md text-sm font-medium">Shop</a>
    ...
    <div className="font-bold text-xl bg-blue-700 w-full text-white flex justify-between sm:hidden">
    <div className="flex-1 flex items-center justify-center sm:items-stretch sm:justify-start">
        <div className="flex justify-center items-center gap-2 px-4">
            <FontAwesomeIcon icon={faBars} />
            <h3 className="text-sm">Shop By Categories</h3>
        </div>
          <div className="hidden sm:block sm:ml-6">
            <div className="flex space-x-4">
